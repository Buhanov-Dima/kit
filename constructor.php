...
<body>
	<header>
		<div class="wrap_head_white">
			<div class="menu_white">
				<a href="#">меню</a>
			</div>
			<div class="logo_white">
				<img src="/img/constructor/logo2.png" alt="">
			</div>
			<div class="nmb_user_basket_white">
				<p>+7 495 780 65 65</p>
				<a href="#"><img src="/img/constructor/user.png" alt="user"></a>
				<a href="#"><img src="/img/constructor/shopping-bag.png" alt="basket"></a>
			</div>
		</div>
	</header>
			...
			<div class="row">
				...
				<div class="col-lg-3 mx-auto">
					<div class="left_arrow">
						<img src="/img/constructor/left_arrow.png" alt="left_arrow">
					</div>
				</div>
				<div class="col-lg-3 mx-auto">
						<div class="name">
				...
				<div class="col-lg-3 mx-auto">
					<div class="right_arrow">
						<img src="/img/constructor/right_arrow.png" alt="right_arrow">
					</div>
				</div>
			</div>
		</div>
	</section>
	<section class="content" id="button_red_arrow">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-6 mx-auto pull-right">
					<div class="button_add">
						<p>добавить в кит</p>
					</div>
				</div>
				<div class="col-lg-4 mx-auto">
					<div class="choose_desk">
						<p>выбрать доску</p>
						<div>
